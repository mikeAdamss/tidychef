...
class TestXlsSelectableBoldMethods:
    """Test cases for XlsSelectable bold filtering methods."""
    ...
    def setup_method(self):
        ...
        self.unknown_bold_cell._excel_ref = Mock(return_value="B2")  # Mock excel ref for error message
    ...
    def test_is_bold_raises_error_on_unknown_formatting(self):
        ...
        assert "B2" in exc_info.value.msg
