...
def test_box_select(selectable_simple1: Selectable):
    ...
    """
    selection = selectable_simple1.cell_containing_string("W97val").box_select()
...
def test_box_select_with_blank(selectable_simple1_with_blank_in_bottom_right_corner: Selectable):
    ...
    """
    selection = selectable_simple1_with_blank_in_bottom_right_corner.cell_containing_string("W97val").box_select()
...
def test_box_select_with_keep_blanks(selectable_simple1_with_blank_in_bottom_right_corner: Selectable):
    ...
    """
    selection = selectable_simple1_with_blank_in_bottom_right_corner.cell_containing_string("W97val").box_select(remove_blank=False)
