def main():
    ...
    preview(
        anchor, identifier, category, cdid, time_period, observations, bounded="A4:Z16"
    )
    ...
    tidy_data = TidyData(
        ...
        Column(
            category.finds_observations_directly(right),
            apply=lambda x: x.split("[")[0].strip(),
        ),
        Column(
            time_period.finds_observations_directly(right),
